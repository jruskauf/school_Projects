...
uint8_t const PALETTES[] = {
    ...
    COLOR_DGRAY, COLOR_WHITE, COLOR_LGRAY, // sprite palette 0 (00)
    COLOR_BLACK,                           // ignored
    COLOR_YELLOW, COLOR_GREEN, COLOR_BLUE, // sprite palette 1 (01)
    COLOR_BLACK,                           // ignored
    COLOR_RED, COLOR_RED, COLOR_RED,       // sprite palette 2 (10)
    0,                                     // ignored
