...
//
//primreg.c : Calculate prime numbers using: odd numbers only
//
/////////////////////////////////////////////////////////////////////////
...
int main(int argc, char **argv)
{
	...
	//This sets QTY and number based on LowB's value	
	if (LowB <= 3){
		fprintf(primelist,"2 ");
		QTY=1;
		number = 3;
	...
	|* generated.  This program ommits counting even numbers by     *|
	|* only calculating the odd numbers, as only odd numbers can be *|
	|* prime numbers.                                               *|
	'*==============================================================*/ 
