...
//
//primregb.c : Calculate prime numbers using: break on composite strategy
//
//////////////////////////////////////////////////////////////////////////
...
int main(int argc, char **argv)
{
	...
	|* generated.  This has the implimentation of breaking out of   *|
	|* the for loop when a composite is detected.                   *|
	'*==============================================================*/ 
