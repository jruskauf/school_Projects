...
int main(int argc, char **argv)
{
	...
	|* well.  This also incorperates a break on composite for       *|
	|* minnum, and a break on composite that relies on whether      *|
	|* the lower number has broken on composite or not.             *|
	'*==============================================================*/ 
