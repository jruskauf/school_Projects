...
#define  CONVERT         8.210
#define  DELIM           " <> "
#define  SRCUNITNAME     "stadions"
#define  SRCUNIT         "st"
#define  DSTUNITNAME     "miles"
#define  DSTUNITNAMESING "mile"
#define  DSTUNIT         "mi"
...
void usage(char *argv)
{
    ...
    fprintf(stdout, "  -T \"TYPE\"   specify cubit type (default: \"persian\")\n");
    ...
    fprintf(stdout, "  egyptian    7.700%s\n", SRCUNIT);
    fprintf(stdout, "  itinerary   10.250%s\n", SRCUNIT);
    fprintf(stdout, "  olympic     9.144%s\n", SRCUNIT);
    fprintf(stdout, "  persian     %.3lf%s\n", CONVERT, SRCUNIT);
    fprintf(stdout, "  ptolemaic   8.699%s\n", SRCUNIT);
}
