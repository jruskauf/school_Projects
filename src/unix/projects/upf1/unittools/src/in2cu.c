...
#define  CONVERT         18.0
#define  DELIM           ","
#define  SRCUNITNAME     "inches"
#define  SRCUNIT         "in"
#define  DSTUNITNAME     "cubits"
#define  DSTUNITNAMESING "cubits"
#define  DSTUNIT         "cu"
...
void usage(char *argv)
{
    ...
    fprintf(stdout, "  -T \"TYPE\"   specify cubit type (default: \"biblical\")\n");
    ...
    fprintf(stdout, "  biblical    biblical cubit (%.1lf%s)\n", CONVERT, SRCUNIT);
    fprintf(stdout, "  egyptian    ancient egyptian cubit (20.7%s)\n", SRCUNIT);
    fprintf(stdout, "  greece      ancient greek standard cubit (18.1%s)\n", SRCUNIT);
    fprintf(stdout, "  greek       ancient greek short cubit (13.2%s)\n", SRCUNIT);
    fprintf(stdout, "  roman       ancient roman cubit (17.47%s)\n", SRCUNIT);
    fprintf(stdout, "  sumerian    ancient sumerian cubit (20.42%s)\n", SRCUNIT);
}
