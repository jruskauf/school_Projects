 ...
 **                    forward (right) and reverse (left) directions
 **
...
int main()
{
    ...
    //////////////////////////////////////////////////////////////////
    //
    // list with cycle to the same node (in right direction)
    //
    mknode(&ltmp1);
    for (i = 0; i < 17; i+=2)
    {
    ...
    ntmp           = ltmp1 -> lead -> right -> right -> right -> right;
    ntmp -> right  = ntmp;

    //////////////////////////////////////////////////////////////////
    //
    // list with cycle to the previous node (in right direction)
    //
    mknode(&ltmp2);
    for (i = 0; i < 17; i+=2)
    {
    ...
    ntmp           = ltmp2   -> lead -> right -> right;
    ntmp -> right  = ntmp    -> left;

    //////////////////////////////////////////////////////////////////
    //
    // list with 2-back cycle (in right direction)
    //
    mknode(&ltmp3);
    for (i = 0; i < 17; i+=2)
    {
    ...
    ntmp           = ltmp2   -> lead -> right -> right -> right;
    ntmp -> right  = ntmp    -> left    -> left;
