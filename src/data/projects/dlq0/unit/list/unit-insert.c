...
int main()
{
    ...
    for(i = 0; i < 4; i++)
    {
        ...
        ntmp       = NULL;
        mknode(&ntmp, data[i]);
        result     = insert(&ltmp, ltmp -> lead, ntmp);
        fprintf(stdout, " you have: "); 
        listcat(ltmp);
        fprintf(stdout, "should be: %s\n", output[num++]); 
        fflush(stdout);
    ...
    ntmp       = NULL;
    mknode(&ntmp, data[i]);
    result         = insert(&ltmp, ltmp -> last -> left, ntmp);
    fprintf(stdout, " you have: ");
    listcat(ltmp);
    fprintf(stdout, "should be: %s\n", output[num++]); 
    fflush(stdout);
    ...
    ntmp       = NULL;
    mknode(&ntmp, data[i]);
    result         = insert(&ltmp, ltmp -> last -> left -> left, ntmp);
    fprintf(stdout, " you have: ");
    listcat(ltmp);
    fprintf(stdout, "should be: %s\n", output[num++]); 
    fflush(stdout);
    ...
    ntmp       = NULL;
    mknode(&ntmp, data[i]);
    result = insert(&ltmp, ltmp -> last -> left -> left -> left -> left, ntmp);
    fprintf(stdout, " you have: ");
    listcat(ltmp);
    fprintf(stdout, "should be: %s\n", output[num++]); 
    fflush(stdout);
    ...
    fprintf(stdout, "Test %d: Inserting %d before start -> right ...\n", testno++, data[i]);
    ntmp       = NULL;
    mknode(&ntmp, data[i]);
    result   = insert(&ltmp, ltmp -> lead -> right, ntmp);
    fprintf(stdout, " you have: ");
    listcat(ltmp);
    fprintf(stdout, "should be: %s\n", output[num++]); 
    fflush(stdout);
