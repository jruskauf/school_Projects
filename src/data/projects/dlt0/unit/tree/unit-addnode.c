...
int main()
{
    ...
    for (i = 1; i < 9; i++)
    {
        ...
        switch (i)
        {
            ...
            case 2:
                tmp                  = myTree -> root -> right;
                nothing              = 0;
                break;

            case 3:
                tmp                  = myTree -> root -> left -> right;
                nothing              = 0;
                break;
            ...
            case 5:
                tmp                  = myTree -> root -> left -> left -> left;
                nothing              = 0;
                break;

            case 6:
                tmp                  = myTree -> root -> left -> left -> left -> left;
                nothing              = 0;
                break;

            case 7:
                tmp                  = myTree -> root -> left -> left -> left -> left -> left;
                nothing              = 1;
                break;

            case 8:
                tmp                  = myTree -> root -> left -> left -> right;
                nothing              = 0;
                break;
        }
