...
int main()
{
	...
	ntmp         = NULL;
	mknode(&ntmp, data[i]);
	result       = append(&ltmp, ltmp -> lead, ntmp);
	fprintf(stdout, " you have: ");
	listcat(ltmp);
	fprintf(stdout, "should be: %s\n", output[num++]); 
	fflush (stdout);
	...
	ntmp          = NULL;
	mknode(&ntmp, data[i]);
	result        = append(&ltmp, ltmp -> lead -> right, ntmp);
	fprintf(stdout, " you have: ");
	listcat(ltmp);
	fprintf(stdout, "should be: %s\n", output[num++]); 
	fflush (stdout);
	...
	ntmp          = NULL;
	mknode(&ntmp, data[i]);
	result        = append(&ltmp, ltmp -> lead -> right -> right, ntmp);
	fprintf(stdout, " you have: ");
	listcat(ltmp);
	fprintf(stdout, "should be: %s\n", output[num++]); 
	fflush (stdout);
	...
	ntmp          = NULL;
	mknode(&ntmp, data[i]);
	result        = append(&ltmp, ltmp -> lead -> right -> right -> right -> right, ntmp);
	fprintf(stdout, " you have: ");
	listcat(ltmp);
	fprintf(stdout, "should be: %s\n", output[num++]); 
	fflush (stdout);
	...
	fprintf(stdout, "\nTest %d: Appending %d to end -> left ...\n", testno++, data[i]);
	ntmp          = NULL;
	mknode(&ntmp, data[i]);
	result        = append(&ltmp, ltmp -> last -> left, ntmp);
	fprintf(stdout, " you have: ");
	listcat(ltmp);
	fprintf(stdout, "should be: %s\n", output[num++]); 
	fflush (stdout);
