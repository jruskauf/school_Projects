...
int main()
{
    ...
    //////////////////////////////////////////////////////////////////
    //
    // Fourth test: Verify top exists, and is NULL (just like lead)
    //
    fprintf(stdout,     "Test %d: Checking top in new stack ...\n", testno++);
    if (stmp       -> data          == NULL)
        fprintf(stdout, " you have: NULL list element in stack (ERROR)\n");
    else if (stmp  -> top           == stmp -> data -> lead)
    ...
    //////////////////////////////////////////////////////////////////
    //
    // Eighth test: Verify top exists, and is NULL (just like lead)
    //
